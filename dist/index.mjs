...
const logThresholds = ["debug", "info", "warn", "error", "silent"];
 ...
 */
const levelPriority = fromEntriesStrict(
	logThresholds.map((level, index) => [
		level,
		level === "silent" ? Number.POSITIVE_INFINITY : index,
	]),
);
/**
...
function isLogParams(obj) {
	...
	if (
		"withTimestamp" in o &&
		o.withTimestamp !== void 0 &&
		typeof o.withTimestamp !== "boolean"
	)
		return false;
	if (
		"prefixBuilder" in o &&
		o.prefixBuilder !== void 0 &&
